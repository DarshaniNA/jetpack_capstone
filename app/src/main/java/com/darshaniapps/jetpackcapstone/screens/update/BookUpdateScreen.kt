package com.darshaniapps.jetpackcapstone.screens.update
...
import com.darshaniapps.jetpackcapstone.components.*
...
import com.darshaniapps.jetpackcapstone.utils.formatDate
        ...
        Surface(
            ...
            Column(
                ...
                if (bookInfo.loading == true) {
                    ...
                    ShowSimpleForm(book = viewModel.retrievedBooksData.value.data?.first { book: MBook ->
