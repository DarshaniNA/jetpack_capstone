package com.darshaniapps.jetpackcapstone.screens.stats
...
import com.darshaniapps.jetpackcapstone.components.BookImage
import com.darshaniapps.jetpackcapstone.components.ReaderAppBar
import com.darshaniapps.jetpackcapstone.model.BookItem
import com.darshaniapps.jetpackcapstone.model.MBook
import com.darshaniapps.jetpackcapstone.navigation.ReaderScreens
import com.darshaniapps.jetpackcapstone.screens.home.HomeScreenViewModel
import com.darshaniapps.jetpackcapstone.screens.search.BookRow
import java.util.*
...
fun ReaderStatisticsScreen(
    ...
    Scaffold(topBar = {
        ...
        books = if (!viewModel.retrievedBooksData.value.data.isNullOrEmpty()) {
            viewModel.retrievedBooksData.value.data!!.filter { mBook: MBook ->
